...
from constants.data_locker import DATA_LOCKER_EVENT_WEB 
...
# Define DAG
with DAG(
    dag_id='Data_Locker_Web_Ingestion',
    default_args=default_args,
    tags=["Data_Locker", "Web", "Ingestion","Game"],
    ...
    for game in game_config:
        ...
        if config['is_web'] == 1:
            with TaskGroup(group_id = f"Ingest_data_locker_web_{game_code}") as task_group:
                for event_report in DATA_LOCKER_EVENT_WEB:
